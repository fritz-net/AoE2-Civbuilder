...
void Civbuilder::initialize() {
    ...
    this->civBonuses[CIV_BONUS_0_BONUS_0] = {381};
    this->civBonuses[CIV_BONUS_1_TOWN_CENTERS_COST_50_WOOD_STARTING_IN] = {382, 403};
    this->civBonuses[CIV_BONUS_2_FOOT_ARCHERS_EXCEPT_SKIRMISHERS_1_RANGE_IN] = {383};
    this->civBonuses[CIV_BONUS_3_SHEPHERDS_WORK_25_FASTER] = {325, 330};
    this->civBonuses[CIV_BONUS_4_CASTLES_COST_15_IN_CASTLE_25_IN_IMPERIAL_AGE] = {290};
    this->civBonuses[CIV_BONUS_5_MOUNTED_UNITS_20_HIT_POINTS_STARTING_IN_FEUDAL_AGE] = {524};
    this->civBonuses[CIV_BONUS_6_FORAGERS_WORK_10_FASTER] = {343};
    this->civBonuses[CIV_BONUS_7_LOOM_CAN_BE_RESEARCHED_INSTANTLY] = {402};
    this->civBonuses[CIV_BONUS_8_VILLAGERS_5_ATTACK_VS_WILD_BOAR_HUNTERS] = {406};
    this->civBonuses[CIV_BONUS_9_10_POPULATION_IN_IMPERIAL_AGE] = {327, 328, 329};
    this->civBonuses[CIV_BONUS_10_INFANTRY_1_ATTACK_VS_BUILDINGS_PER_AGE] = {344, 731, 732, 733};
    this->civBonuses[CIV_BONUS_11_INFANTRY_COST_15_IN_DARK_20_IN] = {347};
    this->civBonuses[CIV_BONUS_12_MONKS_DOUBLE_HEALING_RANGE] = {336, 353};
    this->civBonuses[CIV_BONUS_13_TOWERS_GARRISON_2X_UNITS_TOWN_CENTERS_GARRISON_10] = {314};
    this->civBonuses[CIV_BONUS_14_FARMS_COST_40] = {334, 335};
    this->civBonuses[CIV_BONUS_15_BARRACKS_AND_STABLE_UNITS_1_ARMOR_IN] = {340};
    this->civBonuses[CIV_BONUS_16_ECONOMIC_DROP_OFF_BUILDINGS_COST_50] = {306, 422, 423, 424};
    this->civBonuses[CIV_BONUS_17_FISHING_SHIPS_2X_HIT_POINTS_2P_ARMOR] = {341};
    this->civBonuses[CIV_BONUS_18_INFANTRY_ATTACK_33_FASTER_STARTING_IN_FEUDAL_AGE] = {302, 226, 425};
    this->civBonuses[CIV_BONUS_19_START_WITH_3_VILLAGERS_50_WOOD_200] = {396};
    this->civBonuses[CIV_BONUS_20_DEMOLITION_SHIPS_50_HIT_POINTS] = {304, 350, 351, 352};
    this->civBonuses[CIV_BONUS_21_TECHNOLOGIES_COST_5_FEUDAL_10_CASTLE_15] = {283, 417, 418, 419};
    this->civBonuses[CIV_BONUS_22_BUILDINGS_10_HP_DARK_20_FEUDAL_30] = {397};
    this->civBonuses[CIV_BONUS_23_FIRE_SHIPS_ATTACK_25_FASTER] = {284};
    this->civBonuses[CIV_BONUS_24_CAMEL_RIDERS_SKIRMISHERS_PIKEMEN_HALBERDIERS_COST_25] = {223};
    this->civBonuses[CIV_BONUS_25_START_WITH_50_WOOD_FOOD] = {342};
    this->civBonuses[CIV_BONUS_26_TOWN_CENTER_DOCK_2X_HIT_POINTS] = {409, 412};
    this->civBonuses[CIV_BONUS_27_TOWN_CENTER_DOCK_WORK_RATE_5_DARK] = {355};
    this->civBonuses[CIV_BONUS_28_MARKET_COSTS_100_WOOD_MARKET_TRADE_COST_ONLY_5] = {337};
    this->civBonuses[CIV_BONUS_29_TRANSPORT_SHIPS_2X_HIT_POINTS_20_CARRY_CAPACITY] = {404};
    this->civBonuses[CIV_BONUS_30_GALLEYS_ATTACK_25_FASTER] = {312};
    this->civBonuses[CIV_BONUS_31_CAMEL_UNITS_25_HIT_POINTS] = {301};
    this->civBonuses[CIV_BONUS_32_GUNPOWDER_UNITS_25_HIT_POINTS] = {300};
    this->civBonuses[CIV_BONUS_33_GOLD_MINERS_WORK_20_FASTER] = {452};
    this->civBonuses[CIV_BONUS_34_SCOUT_CAVALRY_LIGHT_CAVALRY_HUSSAR_1_PIERCE_ARMOR] = {395, 501, 502};
    this->civBonuses[CIV_BONUS_35_WARSHIPS_COST_15_FEUDAL_AGE_15_CASTLE] = {416, 415, 391};
    this->civBonuses[CIV_BONUS_36_INFANTRY_20_HIT_POINTS_STARTING_IN_FEUDAL_AGE] = {394};
    this->civBonuses[CIV_BONUS_37_CAVALRY_ARCHERS_FIRE_25_FASTER] = {389};
    this->civBonuses[CIV_BONUS_38_HUNTERS_WORK_40_FASTER] = {286, 287, 288, 388};
    this->civBonuses[CIV_BONUS_39_LIGHT_CAVALRY_HUSSARS_STEPPE_LANCERS_20_30] = {393, 898, 899, 900};
    this->civBonuses[CIV_BONUS_40_INFANTRY_MOVES_5_10_15_20_FASTER] = {385};
    this->civBonuses[CIV_BONUS_41_LUMBERJACKS_WORK_15_FASTER] = {386};
    this->civBonuses[CIV_BONUS_42_SIEGE_UNITS_FIRE_25_FASTER] = {405};
    this->civBonuses[CIV_BONUS_43_CAN_STEAL_SHEEP_AND_SHEEP_WITHIN_ONE] = {84};
    this->civBonuses[CIV_BONUS_44_MISSIONARIES_CAN_BE_TRAINED_IN_MONASTERIES] = {224};
    this->civBonuses[CIV_BONUS_45_START_WITH_50_GOLD] = {29, 30, 31, 32, 33, 36, 38, 40, 41, 66, 456};
    this->civBonuses[CIV_BONUS_46_5_MONK_HIT_POINTS_FOR_EACH_MONASTERY_TECHNOLOGY] = {554, 227};
    this->civBonuses[CIV_BONUS_47_START_WITH_1_VILLAGER_BUT_50_FOOD] = {458, 459};
    this->civBonuses[CIV_BONUS_48_CAVALRY_ARCHERS_COST_10_CASTLE_20_IMPERIAL_AGE] = {390};
    this->civBonuses[CIV_BONUS_49_RANGED_SOLDIERS_AND_INFANTRY_COST_50_WOOD] = {451};
    this->civBonuses[CIV_BONUS_50_ARCHER_ARMOR_UPGRADES_FREE] = {447, 448};
    this->civBonuses[CIV_BONUS_51_CAN_TRAIN_TURTLE_SHIPS_IN_DOCKS] = {272, 372};
    this->civBonuses[CIV_BONUS_52_CAN_RECRUIT_LONGBOATS_FROM_DOCKS] = {500};
    this->civBonuses[CIV_BONUS_53_GUNPOWDER_UNITS_COST_20] = {521};
    this->civBonuses[CIV_BONUS_54_CAN_UPGRADE_HEAVY_CAMEL_RIDERS_TO_IMPERIAL] = {469};
    this->civBonuses[CIV_BONUS_55_FISHERMEN_WORK_10_FASTER] = {338, 552};
    this->civBonuses[CIV_BONUS_56_STABLE_UNITS_1P_ARMOR_IN_CASTLE_AND] = {496, 497, 498, 553};
    this->civBonuses[CIV_BONUS_57_VILLAGERS_COST_8_DARK_13_FEUDAL_18] = {152, 153, 154, 155};
    this->civBonuses[CIV_BONUS_58_MILITARY_UNITS_COST_10_15_20_25] = {519};
    this->civBonuses[CIV_BONUS_59_BUILDINGS_COST_15_STONE] = {495};
    this->civBonuses[CIV_BONUS_60_HOUSES_SUPPORT_10_POPULATION] = {474, 475, 476, 477, 478, 479};
    this->civBonuses[CIV_BONUS_61_VILLAGERS_AFFECTED_BY_BLACKSMITH_UPGRADES_STARTING_IN] = {528};
    this->civBonuses[CIV_BONUS_62_CAN_RECRUIT_SLINGERS_FROM_ARCHERY_RANGES] = {69};
    this->civBonuses[CIV_BONUS_63_VILLAGERS_KILL_WOLVES_WITH_1_STRIKE] = {473};
    this->civBonuses[CIV_BONUS_64_SCOUT_CAVALRY_LIGHT_CAVALRY_HUSSAR_COST_15] = {511};
    this->civBonuses[CIV_BONUS_65_SIEGE_WORKSHOP_UNITS_15_CHEAPER] = {559};
    this->civBonuses[CIV_BONUS_66_ALL_UNITS_COST_20_GOLD] = {453};
    this->civBonuses[CIV_BONUS_67_FORAGERS_GENERATE_A_TRICKLE_OF_WOOD_33] = {560};
    this->civBonuses[CIV_BONUS_68_SHIPS_10_HP] = {570};
    this->civBonuses[CIV_BONUS_69_CAN_BUILD_FEITORIA_IN_IMPERIAL_AGE] = {596, 597};
    this->civBonuses[CIV_BONUS_70_CAN_BUILD_CARAVELS_IN_DOCKS] = {607};
    this->civBonuses[CIV_BONUS_71_FOOT_ARCHERS_FIRE_18_FASTER] = {587, 588, 589};
    this->civBonuses[CIV_BONUS_72_RECEIVE_100_GOLD_100_FOOD_WHEN_ADVANCING] = {590};
    this->civBonuses[CIV_BONUS_73_PIKEMAN_UPGRADE_FREE] = {595};
    this->civBonuses[CIV_BONUS_74_BUILDINGS_COST_15_WOOD] = {591, 592, 593};
    this->civBonuses[CIV_BONUS_75_BARRACKS_UNITS_1_PIERCE_ARMOR_PER_AGE] = {594};
    this->civBonuses[CIV_BONUS_76_VILLAGERS_DROP_OFF_10_MORE_GOLD] = {584};
    this->civBonuses[CIV_BONUS_77_VILLAGERS_MOVE_5_FASTER_IN_DARK_AGE] = {585};
    this->civBonuses[CIV_BONUS_78_SHIPS_MOVE_10_FASTER] = {586, 613};
    this->civBonuses[CIV_BONUS_79_STABLE_UNITS_COST_15_IN_CASTLE_20_IN_IMPERIAL_AGE] = {672};
    this->civBonuses[CIV_BONUS_80_MELEE_ELEPHANT_UNITS_MOVE_10_FASTER] = {657};
    this->civBonuses[CIV_BONUS_81_VILLAGERS_CAN_GARRISON_IN_HOUSES] = {638};
    this->civBonuses[CIV_BONUS_82_NO_BUILDINGS_REQUIRED_TO_ADVANCE_TO_THE] = {634};
    this->civBonuses[CIV_BONUS_83_ADVANCE_TO_THE_NEXT_AGE_66_FASTER] = {662, 663};
    this->civBonuses[CIV_BONUS_84_ELEPHANT_UNITS_COST_25_CASTLE_35_IN_IMPERIAL_AGE] = {635, 637};
    this->civBonuses[CIV_BONUS_85_FISH_TRAPS_COST_33_AND_PROVIDE_200_FOOD] = {901};
    this->civBonuses[CIV_BONUS_86_FOOT_ARCHERS_AND_CONDOTTIERI_1_MELEE_1] = {645};
    this->civBonuses[CIV_BONUS_87_LUMBER_CAMP_UPGRADES_FREE] = {646, 647, 648};
    this->civBonuses[CIV_BONUS_88_INFANTRY_1_ATTACK_PER_AGE_STARTING_IN] = {649};
    this->civBonuses[CIV_BONUS_89_MONASTERY_TECHNOLOGIES_COST_50] = {665};
    this->civBonuses[CIV_BONUS_90_ENEMY_POSITIONS_ARE_REVEALED_AT_THE_START] = {632};
    this->civBonuses[CIV_BONUS_91_ARCHERY_RANGE_UNITS_AND_FIRE_LANCERS_20_HP] = {693};
    this->civBonuses[CIV_BONUS_92_MILITIA_LINE_UPGRADES_FREE] = {694};
    this->civBonuses[CIV_BONUS_93_TOWN_CENTERS_COST_50_STONE_STARTING_IN] = {695};
    this->civBonuses[CIV_BONUS_94_CAN_BUILD_KREPOST] = {704};
    this->civBonuses[CIV_BONUS_95_LIVESTOCK_ANIMALS_LAST_50_LONGER] = {696};
    this->civBonuses[CIV_BONUS_96_UNITS_DEAL_25_DAMAGE_WHEN_FIGHTING_FROM] = {698};
    this->civBonuses[CIV_BONUS_97_THUMB_RING_PARTHIAN_TACTICS_FREE] = {711, 727, 728};
    this->civBonuses[CIV_BONUS_98_MOUNTED_UNITS_5_FASTER_EACH_AGE_STARTING] = {709, 723, 724};
    this->civBonuses[CIV_BONUS_99_ADDITIONAL_TOWN_CENTER_CAN_BE_BUILT_IN] = {295, 705, 706};
    this->civBonuses[CIV_BONUS_100_SIEGE_WORKSHOP_AND_BATTERING_RAM_AVAILABLE_IN] = {697};
    this->civBonuses[CIV_BONUS_101_RECEIVE_100_FOOD_PER_TOWN_CENTER] = {710};
    this->civBonuses[CIV_BONUS_102_SPEARMEN_AND_SKIRMISHERS_MOVE_10_FASTER] = {699, 700, 701, 702};
    this->civBonuses[CIV_BONUS_103_EACH_GARRISONED_RELIC_GIVES_1_ATTACK_TO] = {768};
    this->civBonuses[CIV_BONUS_104_CAVALIER_UPGRADE_AVAILABLE_IN_CASTLE_AGE] = {769};
    this->civBonuses[CIV_BONUS_105_GUNPOWDER_UNITS_25_ATTACK] = {758, 759, 760, 761, 762, 763, 764, 765, 766, 767};
    this->civBonuses[CIV_BONUS_106_ECONOMIC_UPGRADES_COST_33_FOOD_AND_AVAILABLE] = {770};
    this->civBonuses[CIV_BONUS_107_FORTIFICATIONS_BUILT_50_TOWN_CENTERS_BUILT_100] = {771};
    this->civBonuses[CIV_BONUS_108_SOLDIERS_RECEIVE_33_LESS_BONUS_DAMAGE] = {772, 773, 774, 815, 816, 817};
    this->civBonuses[CIV_BONUS_109_FARM_UPGRADES_PROVIDE_125_ADDITIONAL_FOOD] = {775};
...
void Civbuilder::setupData() {
    ...
    this->civBonuses[CIV_BONUS_109_FARM_UPGRADES_PROVIDE_125_ADDITIONAL_FOOD].push_back((int)(df->Techs.size() - 1));
...
void Civbuilder::createCivBonuses() {
    ...
    t.EffectID = (this->df->Effects.size() - 1);
    this->df->Techs.push_back(t);
    this->civBonuses[CIV_BONUS_308_LEGIONARY_REPLACES_TWO_HANDED_SWORDSMAN_CHAMPION] = {(int)(this->df->Techs.size() - 1)};
    ...
    t.EffectID = (this->df->Effects.size() - 1);
    this->df->Techs.push_back(t);
    this->civBonuses[CIV_BONUS_309_CAN_UPGRADE_HEAVY_SCORPIONS_TO_IMPERIAL_SCORPIONS] = {(int)(this->df->Techs.size() - 1)};
    ...
    t.EffectID = (this->df->Effects.size() - 1);
    this->df->Techs.push_back(t);
    this->civBonuses[CIV_BONUS_310_CAN_UPGRADE_ELITE_BATTLE_ELEPHANTS_TO_ROYAL] = {(int)(this->df->Techs.size() - 1)};
    ...
    t.EffectID = (this->df->Effects.size() - 1);
    this->df->Techs.push_back(t);
    this->civBonuses[CIV_BONUS_133_RESOURCES_LAST_15_LONGER] = {(int)(this->df->Techs.size() - 1), 53, 56};

    // Lumberjack food trickle
    this->civBonuses[CIV_BONUS_134_FOOT_ARCHERS_AND_SKIRMISHERS_COST_10_FEUDAL] = {1071};
    ...
    this->civBonuses[CIV_BONUS_139_STABLE_TECHNOLOGIES_COST_50] = {299, 303, 305, 310};

    // Wonders provide +50 bonus pop space
    this->civBonuses[CIV_BONUS_140_NEW_TOWN_CENTERS_SPAWN_2_SHEEP_STARTING] = {};
    ...
    this->civBonuses[CIV_BONUS_142_VILLAGERS_3_HP_PER_ECONOMIC_TECH_RESEARCHED] = {792, 809, 810, 811};
    ...
    this->civBonuses[CIV_BONUS_362_CAN_TRAIN_MOUNTED_TREBUCHETS] = {dragonShipTech, 1010};
    ...
    this->civBonuses[CIV_BONUS_175_START_WITH_150_WOOD] = {228};
    ...
    this->civBonuses[CIV_BONUS_192_LAND_EXPLOSIVE_UNITS_2X_HP] = {847, 848, 849};

    // Can recruit warrior priests
    this->civBonuses[CIV_BONUS_193_TOWN_CENTERS_SPAWN_2_VILLAGERS_WHEN_THE] = {948};
    ...
    this->civBonuses[CIV_BONUS_204_INFANTRY_1_ATTACK_VS_VILLAGERS_PER_AGE] = {844};
    ...
    this->civBonuses[CIV_BONUS_209_ELEPHANT_UNITS_ATTACK_25_FASTER] = {(int)(df->Techs.size() - 1)};
    ...
    this->civBonuses[CIV_BONUS_211_RECEIVE_50_FOOD_50_WOOD_50_STONE] = {};
    ...
    this->civBonuses[CIV_BONUS_218_GUNPOWDER_UNITS_MOVE_20_FASTER] = {};
    ...
    this->civBonuses[CIV_BONUS_220_MONK_UNITS_MOVE_20_FASTER] = {877};
    ...
    this->civBonuses[CIV_BONUS_105_GUNPOWDER_UNITS_25_ATTACK].push_back((int)(this->df->Techs.size() - 1));
    ...
    this->civBonuses[CIV_BONUS_221_MELEE_CAVALRY_GAIN_2_BONUS_DAMAGE_VS_SKIRMISHERS] = techIDs;
    ...
    this->civBonuses[CIV_BONUS_226_SIEGE_TOWERS_TRAIN_100_FASTER] = {876};
    ...
    this->civBonuses[CIV_BONUS_229_WARSHIPS_10_ATTACK_VS_VILLAGERS] = {};
    ...
    t.Civ = 99;
    this->df->Techs.push_back(t);
    this->civBonuses[CIV_BONUS_239_BERRIES_CONTAIN_35_MORE_FOOD] = {(int)(df->Techs.size() - 1)};
    ...
    this->civBonuses[CIV_BONUS_247_SIEGE_UNITS_1_PIERCE_ARMOR_IN_CASTLE] = {(int)(df->Techs.size() - 1)};
    ...
    this->civBonuses[CIV_BONUS_257_SCOUTS_LIGHT_CAVALRY_HUSSAR_4_ATTACK_VS] = {887};
    ...
    techIDs.push_back((int)(df->Techs.size() - 1));
    this->civBonuses[CIV_BONUS_270_TOWERS_DEAL_EXTRA_DAMAGE_TO_CAVALRY] = techIDs;
    ...
    this->civBonuses[CIV_BONUS_280_EACH_MONASTERY_TECHNOLOGY_RESEARCHED_BRINGS_A_MONK] = {793, 794, 795, 796, 797, 798, 799, 818, 819, 820, 821};

    // Stone miners generate gold
    this->civBonuses[CIV_BONUS_281_FOLWARK_REPLACES_MILL] = {805, 806, 807};

    // Winged Hussar replaces Hussar
    this->civBonuses[CIV_BONUS_282_STONE_MINERS_GENERATE_GOLD_IN_ADDITION_TO_STONE] = {789, 791};

    // Chemistry in Castle Age
    this->civBonuses[CIV_BONUS_283_WINGED_HUSSAR_REPLACES_HUSSAR] = {800, 801};

    // Spearman-line deals +25% bonus damage
    this->civBonuses[CIV_BONUS_284_CHEMISTRY_AND_HAND_CANNONEER_AVAILABLE_IN_CASTLE] = {802};

    // Fervor and Sanctity affects villagers
    this->civBonuses[CIV_BONUS_285_SPEARMEN_DEALS_25_BONUS_DAMAGE] = {803, 804};

    // Houfnice
    this->civBonuses[CIV_BONUS_286_FERVOR_AND_SANCTITY_AFFECTS_VILLAGERS] = {787};

    // Caravanseri
    this->civBonuses[CIV_BONUS_287_CAN_UPGRADE_BOMBARD_CANNONS_TO_HOUFNICE] = {518};

    // Gunpowder units +1/+1P
    this->civBonuses[CIV_BONUS_288_CAN_BUILD_CARAVANSERI_IN_IMPERIAL_AGE] = {520};

    //+200w per age
    this->civBonuses[CIV_BONUS_289_GUNPOWDER_UNITS_1_1P_ARMOR] = {851, 852, 853};
    ...
    t.Civ = 99;
    this->df->Techs.push_back(t);
    this->civBonuses[CIV_BONUS_290_RECEIVE_200_WOOD_WHEN_ADVANCING_TO_THE_NEXT_AGE] = {(int)(this->df->Techs.size() - 1)};

    // Skirmishers and elephant archers attack 25% faster
    this->civBonuses[CIV_BONUS_291_BARRACKS_TECHNOLOGIES_COST_50] = {845};

    // Elephant units -25% bonus damage and conversion resist
    this->civBonuses[CIV_BONUS_292_SKIRMISHERS_AND_ELEPHANT_ARCHERS_ATTACK_25_FASTER] = {846};

    // Ships regenerate
    this->civBonuses[CIV_BONUS_293_ELEPHANT_UNITS_RECEIVE_25_LESS_BONUS_DAMAGE] = {850};

    // Start with 2 forage bushes
    this->civBonuses[CIV_BONUS_294_SHIPS_REGENERATE_15_HP_PER_MINUTE] = {857};

    // Livestock garrison mills
    this->civBonuses[CIV_BONUS_295_START_WITH_2_FORAGE_BUSHES] = {856};

    // Mounted units +20/30/40% damage
    this->civBonuses[CIV_BONUS_296_CAN_GARRISON_MILLS_WITH_LIVESTOCK_TO_PRODUCE_FOOD] = {854, 859, 874};

    // Garrison fishing ships
    this->civBonuses[CIV_BONUS_297_MOUNTED_UNITS_DEAL_20_BONUS_DAMAGE_FEUDAL] = {855};

    // Thirisadai
    this->civBonuses[CIV_BONUS_298_CAN_GARRISON_DOCKS_WITH_FISHING_SHIPS] = {841};

    // Shrivamsha
    this->civBonuses[CIV_BONUS_299_CAN_TRAIN_THIRISADAI_IN_DOCKS] = {842, 843};

    // Camel Scouts
    this->civBonuses[CIV_BONUS_300_CAN_RECRUIT_SHRIVAMSHA_RIDERS] = {235, 860, 858};

    //+20g per tech
    this->civBonuses[CIV_BONUS_301_CAN_RECRUIT_CAMEL_SCOUTS_IN_FEUDAL_AGE] = {186, 323, 324, 326};
    ...
    this->civBonuses[CIV_BONUS_303_GALLEY_LINE_AND_DROMONS_1_1_ARMOR] = {640};

    // Monks +3/+3P armor
    this->civBonuses[CIV_BONUS_304_ELEPHANT_UNITS_1_1P_ARMOR] = {870};

    // Blacksmith double effect
    this->civBonuses[CIV_BONUS_305_MONK_UNITS_3_3P_ARMOR] = {889, 890, 891};

    // Scorpions cheap and ballistics
    this->civBonuses[CIV_BONUS_306_INFANTRY_RECEIVES_DOUBLE_EFFECT_FROM_BLACKSMITH_ARMOR] = {892, 893};

    // Legionary
    this->civBonuses[CIV_BONUS_307_SCORPIONS_COST_60_GOLD_AND_BENEFIT_FROM] = {885, 895};

    // Cavalry Archers +2 attack vs archers
    this->civBonuses[CIV_BONUS_311_CAN_UPGRADE_ELITE_STEPPE_LANCERS_TO_ROYAL_LANCERS] = {190};

    // Eco buildings cheaper + effectiveness
    this->civBonuses[CIV_BONUS_312_CAVALRY_ARCHERS_2_ATTACK_VS_ARCHERS_EXCEPT] = {958, 960, 961, 962, 963, 964, 965, 966};
    ...
    // Free relic
    this->civBonuses[CIV_BONUS_313_WOOD_AND_MINING_UPGRADES_ARE_40_MORE] = {949, 957};

    // Savar
    this->civBonuses[CIV_BONUS_314_FIRST_RELIGIOUS_BUILDING_RECEIVES_A_FREE_RELIC] = {526, 527};

    // Extra warship missile
    this->civBonuses[CIV_BONUS_315_SAVAR_REPLACES_PALADIN] = {959};

    // Fortified church
    this->civBonuses[CIV_BONUS_316_GALLEY_LINE_AND_DROMONS_FIRE_AN_ADDITIONAL] = {930};

    // Mule carts
    this->civBonuses[CIV_BONUS_317_FORTIFIED_CHURCH_REPLACES_MONASTERY] = {932};

    // Start with mule cart
    this->civBonuses[CIV_BONUS_318_MULE_CARTS_REPLACE_LUMBER_CAMPS_AND_MINING_CAMPS] = {229, 925};

    // Church work bonus area
    this->civBonuses[CIV_BONUS_319_START_WITH_A_MULE_CART] = {934};

    // Less bonus damage from higher elevation
    this->civBonuses[CIV_BONUS_320_RELIGIOUS_BUILDINGS_PROVIDE_VILLAGERS_IN_AN_8] = {926};

    // Cavalry regen
    this->civBonuses[CIV_BONUS_321_UNITS_AND_BUILDINGS_RECEIVE_15_DAMAGE_WHEN] = {937, 938, 939};

    // Flaming camel bonus
    this->civBonuses[CIV_BONUS_322_MOUNTED_UNITS_REGENERATE_2_8_14_HP] = {703};
    ...
    t.EffectID = (int)(this->df->Effects.size() - 1);
    this->df->Techs.push_back(t);
    this->civBonuses[CIV_BONUS_325_VILLAGERS_WORK_FASTER_WHEN_NEARBY_OTHER_VILLAGERS] = {(int)(this->df->Techs.size() - 1)};
    ...
    this->civBonuses[CIV_BONUS_327_TRADE_YIELDS_10_STONE_IN_ADDITION_TO_GOLD] = techIDs;
    ...
    this->civBonuses[CIV_BONUS_329_CAVALRY_ARCHERS_CAN_DODGE_ONE_PROJECTILE] = techIDs;
    ...
    this->civBonuses[CIV_BONUS_332_ARCHERY_RANGE_TECHS_COST_50] = techIDs;
    ...
    this->civBonuses[CIV_BONUS_334_SIEGE_TOWERS_CAN_FIRE_ARROWS] = {983, 984};

    // Archery Unit technologies at the Archery Range and Blacksmith cost -25%
    this->civBonuses[CIV_BONUS_335_FIRE_LANCERS_AND_FIRE_SHIPS_MOVE_5] = {1067};

    // Siege Weapons and Siege Warships move +10/15% faster in Castle/Imperial Age
    this->civBonuses[CIV_BONUS_336_ARCHERY_UNIT_TECHNOLOGIES_AT_THE_ARCHERY_RANGE] = {1068, 1072};

    // War Chariots
    this->civBonuses[CIV_BONUS_337_SIEGE_WEAPONS_AND_SIEGE_WARSHIPS_MOVE_10] = {1065};

    // Liu Bei
    this->civBonuses[CIV_BONUS_338_CAN_RECRUIT_WAR_CHARIOTS] = {1066};

    // Military production buildings and Docks provide +65 food
    this->civBonuses[CIV_BONUS_339_GAIN_ACCESS_TO_LIU_BEI] = {1084};

    // Infantry regenerates 10/20/30 HP per minute in Feudal/Castle/Imperial Age
    this->civBonuses[CIV_BONUS_340_MILITARY_PRODUCTION_BUILDINGS_AND_DOCKS_PROVIDE_65] = {1085, 1086, 1087};

    // Jian Swordsmen and Hei Guang Cavalry +2 attack in Imperial Age
    this->civBonuses[CIV_BONUS_341_INFANTRY_REGENERATES_10_20_30_HP_PER] = {1076};

    // Careening, Dry Dock available one age earlier, cost and research time -75%
    this->civBonuses[CIV_BONUS_342_JIAN_SWORDSMEN_AND_HEI_GUANG_CAVALRY_2] = {1077, 1078, 1079};

    // Jian Swordsmen
    this->civBonuses[CIV_BONUS_343_CAREENING_DRY_DOCK_AVAILABLE_ONE_AGE_EARLIER] = {1075};

    // Sun Jian
    this->civBonuses[CIV_BONUS_344_CAN_RECRUIT_JIAN_SWORDSMEN] = {1083};

    // Receive one free Villager for each Mill, Lumber- and Mining Camp technology researched
    this->civBonuses[CIV_BONUS_345_GAIN_ACCESS_TO_SUN_JIAN] = {1039, 1040, 1041, 1042, 1043, 1044, 1045, 1046, 1047, 1048};

    // Hei Guang Cavalry and Xianbei Raider +15/30% HP in Castle/Imperial Age
    this->civBonuses[CIV_BONUS_346_RECEIVE_ONE_FREE_VILLAGER_FOR_EACH_MILL] = {1056, 1057, 1058, 1059};

    // Trebuchet units cost -25%
    this->civBonuses[CIV_BONUS_347_HEI_GUANG_CAVALRY_AND_XIANBEI_RAIDER_15] = {1060};

    // Xianbei Raiders
    this->civBonuses[CIV_BONUS_348_TRACTION_TREBUCHETS_AND_LOU_CHUANS_COST_25] = {1037};

    // Cao Cao
    this->civBonuses[CIV_BONUS_349_CAN_RECRUIT_XIANBEI_RAIDERS] = {1038};

    // Meat of hunted and livestock animals doesn't decay
    this->civBonuses[CIV_BONUS_350_GAIN_ACCESS_TO_CAO_CAO] = {993};

    // Mounted units and Fire Lancers attack +20% faster starting in Feudal Age
    this->civBonuses[CIV_BONUS_351_MEAT_OF_HUNTED_AND_LIVESTOCK_ANIMALS_DOESN_T_DECAY] = {994};

    // Siege Engineers available in Castle Age
    this->civBonuses[CIV_BONUS_352_MOUNTED_UNITS_AND_FIRE_LANCERS_ATTACK_20] = {978};

    // Siege and Fortification upgrades cost -75% wood and research +100% faster
    this->civBonuses[CIV_BONUS_353_SIEGE_ENGINEERS_AVAILABLE_IN_CASTLE_AGE] = {995};

    // Units receive -50% friendly fire damage
    this->civBonuses[CIV_BONUS_354_SIEGE_AND_FORTIFICATION_UPGRADES_COST_75_WOOD] = {1009};

    // Grenadiers
    this->civBonuses[CIV_BONUS_355_UNITS_RECEIVE_50_FRIENDLY_FIRE_DAMAGE] = {992};

    // Pastures
    this->df->Effects[1008].EffectCommands.push_back(createEC(102, -1, -1, -1, 216));
    this->civBonuses[CIV_BONUS_356_CAN_RECRUIT_GRENADIERS] = {1008, 1012, 1013, 1014};

    // Shepherds and Herders generate +10% additional food
    this->civBonuses[CIV_BONUS_357_PASTURES_REPLACE_FARMS_AND_MILL_UPGRADES] = {1003};

    // Melee attack upgrade effects are doubled
    this->civBonuses[CIV_BONUS_358_SHEPHERDS_AND_HERDERS_GENERATE_10_ADDITIONAL_FOOD] = {998, 999, 1000};

    // Skirmishers, Spearman- and Scout Cavalry-line train and upgrade +25% faster
    this->civBonuses[CIV_BONUS_359_MELEE_ATTACK_UPGRADE_EFFECTS_ARE_DOUBLED] = {1011};

    // Heavy Cavalry Archer upgrade available in Castle Age and costs -50%
    this->civBonuses[CIV_BONUS_360_SKIRMISHERS_SPEARMAN_AND_SCOUT_CAVALRY_LINE_TRAIN] = {1004};

    // Mounted Trebuchets
    this->civBonuses[CIV_BONUS_361_HEAVY_CAVALRY_ARCHER_UPGRADE_AVAILABLE_IN_CASTLE] = {1005};
    ...
    t.RequiredTechs.push_back(805);
    t.RequiredTechs.push_back(this->civBonuses[CIV_BONUS_135_LUMBERJACKS_GENERATE_FOOD_IN_ADDITION_TO_WOOD][0]);
    t.RequiredTechCount = 2;
    t.EffectID = (this->df->Effects.size() - 1);
    t.Civ = -1;
    this->df->Techs.push_back(t);
    ...
    t.RequiredTechs.push_back(754);
    t.RequiredTechs.push_back(this->civBonuses[CIV_BONUS_120_CONSCRIPTION_FREE][0]);
    t.RequiredTechCount = 2;
    t.EffectID = (this->df->Effects.size() - 1);
    t.Civ = -1;
    this->df->Techs.push_back(t);
    ...
    t.Civ = -1;
    t.RequiredTechCount = 2;
    t.RequiredTechs.push_back(this->civBonuses[CIV_BONUS_333_KNIGHTS_AVAILABLE_IN_FEUDAL_AGE_WITH_30HP][0]);
    t.RequiredTechs.push_back(199);
    t.EffectID = (int)(this->df->Effects.size() - 1);
    this->df->Techs.push_back(t);
    ...
    t.RequiredTechCount = 2;
    t.RequiredTechs.push_back(this->civBonuses[CIV_BONUS_333_KNIGHTS_AVAILABLE_IN_FEUDAL_AGE_WITH_30HP][0]);
    t.RequiredTechs.push_back(this->civBonuses[CIV_BONUS_269_BOMBARD_TOWERS_DEAL_EXTRA_DAMAGE_TO_RAMS][0]);
    t.EffectID = (int)(this->df->Effects.size() - 1);
    this->df->Techs.push_back(t);

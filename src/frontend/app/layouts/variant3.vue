<template>
  <div class="app-layout">
    <nav class="navigation" v-if="showNavigation">
      ...
      <!-- VARIANT 3: Left navigation with "Bug Tracker" label (minimal, text-focused) -->
...
/* VARIANT 3 STYLES: Text-only button with greyish color, subtle style */
.github-link {
  background: linear-gradient(to bottom, rgba(90, 90, 90, 0.85), rgba(60, 60, 60, 0.85));
  color: #c0c0c0;
  border: 2px solid #888;
  font-size: min(1.8vh, 0.9vw);
}

.github-link:hover {
  background: linear-gradient(to bottom, rgba(110, 110, 110, 0.9), rgba(80, 80, 80, 0.9));
  transform: translateY(-2px);
  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.6);
}
